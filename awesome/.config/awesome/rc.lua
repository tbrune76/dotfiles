...
-- TBR
beautiful.font = "Hack Nerd Font 9.5"
beautiful.hotkeys_font = "Hack Nerd Font 9.5"
beautiful.hotkeys_description_font = "Hack Nerd Font 9.5"
--beautiful.hotkeys_font = "Terminus 9.5"
--beautiful.hotkeys_description_font = "Terminus 9.5"
beautiful.border_width = 2
beautiful.border_focus = "#D01515"
beautiful.useless_gap = 3
beautiful.border_normal = "#606060"
...
globalkeys = mytable.join(
	...
	function()
		awful.spawn( string.format("rofi -show combi -theme %s", rofi_theme) )
	end,
	...
	awful.key({ "Control" }, "ö",
	function()
		--awful.spawn( "clipmenu -i -fn Terminus:size=10" )
	...
	awful.key({ modkey }, "x",
	function()
		awful.spawn( string.format("rofi -show menu -modi 'menu:rofi-power-menu' -theme %s", rofi_theme) )
	end,
		{description = "rofi power menu", group = "rofi"}),

	awful.key({ modkey, altkey }, "s",
	function()
		awful.spawn( string.format("rofi -show ssh -theme %s", rofi_theme) )
	end,
		{description = "rofi ssh", group = "rofi"}),

	awful.key({ modkey, altkey }, "f",
	function()
		awful.spawn( string.format("rofi -show filebrowser -theme %s", rofi_theme) )
	end,
		{description = "rofi filebrowser", group = "rofi"}),
	...
	awful.key({ }, "Print",
	function()
		awful.util.spawn( "flameshot gui -d 3000" )
	end,
...
-- Destroy all notifications
    ...
    awful.key({ modkey, altkey, "Control", "Shift" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey, altkey, "Control", "Shift"   }, "q", awesome.quit,
    ...
    awful.key({ modkey,           }, "ü", function () awful.layout.inc( 1)                end,
              {description = "select next", group = "layout"}),
    awful.key({ modkey, "Shift"   }, "ü", function () awful.layout.inc(-1)                end,
